...
import {ArrowChevron, ArrowFlow, ArrowLoop, ArrowSweepUp} from "@/components/common/Arrows";
    ...
    <div className="flex h-screen flex-col items-center justify-center font-sans bg-background text-foreground">
      <div className="w-[45%]">
        ...
        <div className="flex flex-col relative mt-10 items-start  pr-6">
          ...
          <p className="my-4">You can reach my anytime on 
          <Link href={"mailto:uchepibe@gmail.com"}><span className="font-bold text-foreground decoration-warning decoration-2 hover:text-primary underline"> uchepibe@gmail.com</span></Link></p>
        </div>
      </div>
    </div>
  );
